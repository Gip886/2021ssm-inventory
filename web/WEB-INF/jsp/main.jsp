...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo layui-hide-xs layui-bg-black">库存管理系统后台 GIP</div>
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <%--            <li class="layui-nav-item layui-hide-xs"><a href="">订单管理</a></li>--%>
            <%--            <li class="layui-nav-item layui-hide-xs"><a href="">用户信息</a></li>--%>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item">
                    <a href="./404" target="myframe">系统管理</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <iframe id="iframeMain" src="./welcome" width="100%" height="100%" align="center" scrolling="auto" frameborder="0" style="filter:chroma(color=#ffffff)"  name="myframe" allowTransparency="true"></iframe>
