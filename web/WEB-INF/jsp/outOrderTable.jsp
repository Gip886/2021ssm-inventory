                ...
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="orderCustomerId" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">仓库ID</label>
                            <div class="layui-input-inline">
                                <input type="text" name="orderStorageId" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'orderCustomerId',minWidth: 150,  title: '客户ID' ,hide:'true' },
                ...
                {field: 'customerName',minWidth: 100,  title: '客户名称'},
                ...
                {field: 'orderProductNum',minWidth: 100,  title: '产品数量', sort: true},
