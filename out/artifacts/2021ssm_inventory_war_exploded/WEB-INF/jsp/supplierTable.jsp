                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="supplierId" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'supplierId', width: 100, title: '供货商id', sort: true,align:"center"},
                {field: 'supplierName', minWidth: 150, title: '供货商名称', sort: true},
                {field: 'supplierAddress',minWidth: 150,  title: '供货商地址'},
                {field: 'supplierPhone', minWidth: 120, title: '手机号'},
